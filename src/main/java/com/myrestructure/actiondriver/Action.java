package com.myrestructure.actiondriver;
...
public class Action extends BaseClass {
	...
	public static boolean type(WebElement ele, String pNumber) {
		boolean flag = false;
		try {
			flag = ele.isDisplayed();
		...
		return flag;
          ...
          public static void sendKeysUsingJavaScriptById(WebDriver driver, String Id, String val){
//        	  WebElement userNameTxt = driver.findElement(By.xpath(xpath)); 
        	  JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;  
        	  // set the text
        	  
        	  jsExecutor.executeScript("document.getElementById('"+Id+"').value='"+val+"'");  
        	  //get the text
